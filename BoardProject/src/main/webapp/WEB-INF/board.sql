...
AS
SELECT BC.*, 
(SELECT COUNT(*) FROM BOARD_COMMENT_LIKE BCL 
WHERE BC.BOARD_COMMENT_NO = BCL.BOARD_COMMENT_NO) AS COMMENT_LIKE,
(SELECT COUNT(*) FROM BOARD_COMMENT_HATE BCH 
WHERE BC.BOARD_COMMENT_NO = BCH.BOARD_COMMENT_NO) AS COMMENT_HATE
